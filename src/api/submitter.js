...
export function createSubmitterApi(submitterApiBase, service = 'submitter') {
  ...
  return {
    ...
    fetchNewAuthorVideos(author) {
      return postJson(`${submitterApiBase}/authors/fetch-new`, { author }, describe('增量拉取作者新视频'))
    },
    ...
    createTopic(topic) {
      return postJson(`${submitterApiBase}/submitter-author-types/topics`, { topic }, describe('新建投稿Topic'))
    },
