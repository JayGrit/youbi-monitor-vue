...
export function useMonitorApp() {
  ...
  const failureLogs = reactive({
    ...
    loadedAt: failureLogLoadedAt,
    filters: {
      stage: failureLogStageFilter,
      topic: failureLogTypeFilter,
      time: failureLogTimeFilter,
      platform: failureLogPlatformFilter,
    },
    options: {
      stages: failureLogStageOptions,
      types: failureLogTypeOptions,
      platforms: failureLogPlatformOptions,
    },
    filteredRows: filteredFailureLogRows,
    selectedIds: failureLogSelectedIds,
    selectedSet: failureLogSelectedSet,
    allSelected: failureLogAllSelected,
    load: loadFailureLogs,
    resetFilters: resetFailureLogFilters,
    clearSelection: clearFailureLogSelection,
    toggleRow: toggleFailureLogRow,
    toggleAll: toggleFailureLogAll,
    markActualPublished: markSelectedFailureLogActualPublished,
    retryUploads: retrySelectedFailureLogUploads,
    abandonUploads: abandonSelectedFailureLogUploads,
    deferTasks: deferSelectedFailureLogTasks,
  })
  ...
  const taskModel = reactive({
    ...
    setTopicFilter,
    setStageFilter: setTaskStageFilter,
    setTaskIdFilter,
    applyTaskIdFilter,
  })
  ...
  const accounts = reactive({
    ...
    clearPolling: clearAccountPolling,
  })
  ...
  const taskFlow = reactive({
    ...
    open: openTaskFlow,
    close: closeTaskFlow,
    refresh: refreshTaskFlow,
    load: loadTaskFlow,
    selectStage: selectTaskFlowStage,
  })

  const submitter = reactive({
    videos: submitterVideos,
    ...
    busy: submitterBusy,
    page: submitterPage,
    pageCount: submitterPageCount,
    selectedIds: submitterSelectedIds,
    selectedCount: submitterSelectedCount,
    authors: submitterAuthors,
    authorTypeRows: submitterAuthorTypeRows,
    monitorState: submitterMonitorState,
    monitorLoading: submitterMonitorLoading,
    monitorError: submitterMonitorError,
    monitorLoadedAt: submitterMonitorLoadedAt,
    monitorContinueBusy: submitterMonitorContinueBusy,
    loadVideos: loadSubmitterVideos,
    loadAuthors: loadSubmitterAuthors,
    loadMonitor: loadSubmitterMonitor,
    continueAuthorScan: continueSubmitterAuthorScan,
    applyFilters: applySubmitterFilters,
    resetFilters: resetSubmitterFilters,
    submitInput: submitSubmitterInput,
  })
